...
#define STRING_CONFIG_H_AUTHOR "(Emiliyan Tanev, 26-06-2020, Sapphire Plus SKR 1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Sapphire Plus 3d Printer"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS _X 10      // Don't use more than 15 points per axis, implementation limited.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
